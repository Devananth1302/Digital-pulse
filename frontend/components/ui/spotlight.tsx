/**
 * Spotlight Component - Glassmorphism accent effect
 * Creates an animated spotlight that follows mouse for interactive feel
 */
...
export const Spotlight = ({
  ...
  return (
    <motion.div
      ref={containerRef}
      className={cn(
        'pointer-events-none absolute rounded-full backdrop-blur-3xl transition-opacity duration-300',
